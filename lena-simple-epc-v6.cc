...
int main(int argc, char *argv[]) {
	string fadingEnd = "/home/dgdmacedo/ns-3/ns-allinone-3.34/ns-3.34/src/lte/model/fading-traces/fading_trace_ETU_3kmph.fad";
	string lambda = "0.25";
	...
	cmd.AddValue("fadingEnd","Adress of the fading traces", fadingEnd);
	...
	cmd.AddValue("appStartTime", "Start time of the application", appStartTime);
